  ...
  return createPortal(
    ...
    <div
      ...
      <button
        ...
        <span className="text">切换条纹样式</span>
      </button>
      <DropDown
        buttonLabel="垂直对齐"
        buttonClassName="item"
        buttonAriaLabel="垂直对齐选项">
        <DropDownItem
          onClick={() => {
      ...
      <button
        ...
        <span className="text">
          在左侧插入 {selectionCounts.columns} 列
        </span>
      </button>
      <button
        type="button"
        ...
        <span className="text">
          在右侧插入 {selectionCounts.columns} 列
        </span>
      </button>
      <hr />
      <button
